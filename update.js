        ...
        for (var i = 0; i < tables.length; i++) {
          ...
          for (var j = 1; j < tables[i].rows.length; j++) {
            ...
            results.push({
              ...
              ateam: tables[i].rows[j].cells[4].innerText.trim().replace(
                  ' PN', ''),
              ascore: scores[0].trim(),
              bscore: scores[1].trim(),
              bteam:
                  tables[i].rows[j].cells[6].innerText.trim().replace(' PN', '')
            });
          }
        }
        return results
        ...
        for (var i = 0; i < tables.length; i++) {
          for (var j = 1; j < tables[i].rows.length; j++) {
            rankings.push({
              ...
              teams: tables[i].rows[j].cells[1].innerText.trim().replace(
                  ' PN', ''),
        ...
        for (var i = 0; i < tables.length; i++) {
          for (var j = 1; j < tables[i].rows.length; j++) {
            players.push({
              ...
              teams: tables[i].rows[j].cells[2].innerText.trim().replace(
                  ' PN', ''),
              ...
              box:
                  tables[i].rows[j].cells[7].innerText.trim().replace(' "', ''),
            });
          }
        }
        return players
